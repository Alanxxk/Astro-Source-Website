...
export const fontsList: FontDefinition[] = [
	...
	// 3. 在 fontConfig.selected 或区域字段中引用 cssVariable
	{
  	...
  	{
		name: "Dream Han Sans",
		cssVariable: "--font-dream-han-sans",
		provider: "local",
		options: {
			variants: [
				{
					src: ["./public/assets/fonts/DreamHanSans-W23.ttf"],
				},
			],
		},
		fallbacks: ["sans-serif"],
...
export const fontConfig: FontSelectionConfig = {
	...
	selected: ["--font-dream-han-sans"],

	// 各区域独立字体设置（填写上方 fonts 中的 cssVariable，留空则使用全局 selected 字体）
	// 例如：bannerTitleFont: "--font-inter", 表示主页横幅主标题使用 Inter 字体
	// 主页横幅主标题字体
	bannerTitleFont: "--font-dream-han-sans",//"--font-zen-maru-gothic",
	// 主页横幅副标题字体
	bannerSubtitleFont: "--font-dream-han-sans",//"--font-inter",
	// 导航栏标题字体
	navbarTitleFont: "--font-dream-han-sans",//"",
	// 代码块字体（用于代码高亮和等宽字体场景）
	codeFont: "--font-dream-han-sans",//"--font-jetbrains-mono",
