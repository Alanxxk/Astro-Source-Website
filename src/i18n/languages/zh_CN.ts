...
export const zh_CN: Translation = {
  ...
  [Key.bangumiSubtitle]: "探索记录多元艺术媒体世界",
  [Key.bangumiFilterAll]: "全部",
  [Key.bangumiFilterWatched]: "完成",
  [Key.bangumiFilterWatching]: "进行",
  [Key.bangumiFilterWish]: "计划",
  [Key.bangumiFilterOnHold]: "暂缓",
  [Key.bangumiFilterDropped]: "弃坑",
  [Key.bangumiStatusWish]: "计划",
  [Key.bangumiStatusWatched]: "完成",
  [Key.bangumiStatusWatching]: "进行",
  [Key.bangumiStatusOnHold]: "暂缓",
